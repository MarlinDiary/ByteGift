...
export const Toolbar: React.FC<ToolbarProps> = ({
  ...
  const toolButtonVariants = {
    ...
    visible: (custom: number) => ({
      ...
      transition: {
        ...
        stiffness: 120,
        damping: 14,
        delay: 0.15 + custom * 0.06, // 减少延迟时间，加快依次出现的速度
      }
    })
  }
  ...
  return (
    <motion.div
      className="fixed bottom-0 left-0 right-0 mx-auto w-full max-w-4xl px-4"
      initial="hidden"
      animate="visible"
